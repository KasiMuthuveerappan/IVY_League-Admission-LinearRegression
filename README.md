...
## 📝 Case Report
- You can access the complete Case python file here - [Python](https://github.com/KasiMuthuveerappan/Jamboree-LinearRegression/blob/main/K-Analysis/jamboree-k-mastercopy_final.ipynb)
